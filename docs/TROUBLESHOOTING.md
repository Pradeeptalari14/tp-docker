# 🔧 Troubleshooting Guide — Docker Manager
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-docker/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/docker/)
